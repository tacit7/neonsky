...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("neonsky.hsluv")
    if color ~= "NONE" then
...
---@param groups neonsky.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/neonsky-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, neonsky.Cache
